...
mongoose
  ...
  .then(async () => {
    ...
    // Keeps the DB's actual indexes in sync with what's defined in the
    // User schema. Safe to leave running on every boot at this project's
    // size; for a much larger users collection later, this is worth
    // moving to a one-off migration script instead.
